...
public class ZmsZkClient extends ZkClient {
    ...
    public void initZmsZk() {
    }

    public void deleteTopic(String topicName) {
        delete(Utils.buildPath(ZmsConst.ZK.TOPIC_ZKPATH, topicName));
    }

    public void deleteConsumerGroup(String consumerGroupName) {
        delete(Utils.buildPath(ZmsConst.ZK.CONSUMERGROUP_ZKPATH, consumerGroupName));
    }

    public void deleteCluster(String clusterName) {
        delete(Utils.buildPath(ZmsConst.ZK.CLUSTER_ZKPATH, clusterName));
    }

    public ClusterMetadata readClusterMetadata(String clusterName) {
        String clusterData = readData(Utils.buildPath(ZmsConst.ZK.CLUSTER_ZKPATH, clusterName));
    ...
    public boolean checkPath(ZmsType type, String name) {
        ...
        String zkPath = isTopic ?
                Utils.buildPath(ZmsConst.ZK.TOPIC_ZKPATH, name) :
                Utils.buildPath(ZmsConst.ZK.CONSUMERGROUP_ZKPATH, name);
    ...
    private void writeClusterMetadata(String clusterName, String zkMeta) {
        String clusterPath = Utils.buildPath(ZmsConst.ZK.CLUSTER_ZKPATH, clusterName);
    ...
    private void writeTopicMetadata(String topicName, String topicZkData) {
        String topicPath = Utils.buildPath(ZmsConst.ZK.TOPIC_ZKPATH, topicName);
        if (!exists(topicPath)) {
    ...
    private void writeConsumerGroupMetadata(String cgName, String cgZkData) {
        String consumerPath = Utils.buildPath(ZmsConst.ZK.CONSUMERGROUP_ZKPATH, cgName);
    ...
    private ZmsMetadata readZkInfo(String type, String name) {
        ...
        try {
            properties = Utils.parseProperties(zkData);
        } catch (IOException e) {
