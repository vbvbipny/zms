...
public abstract class ZmsConsumerProxy extends ZmsProxy<ZmsConsumerMetrics> implements Consumer {
    ...
    public ZmsConsumerProxy(ZmsMetadata metadata, SLA sla, String name, Properties properties, MessageListener listener) {
        super(metadata, sla, new ZmsConsumerMetrics(metadata.getName(), name));
