...
public abstract class ZmsProducerProxy extends ZmsProxy<ZmsProducerMetrics> implements Producer {
    ...
    ZmsProducerProxy(ZmsMetadata metadata, SLA sla, String name) {
        super(metadata, sla, new ZmsProducerMetrics(metadata.getName(), name));
    }

    ZmsProducerProxy(ZmsMetadata metadata, SLA sla, String name, Properties properties) {
        super(metadata, sla, new ZmsProducerMetrics(metadata.getName(), name));
