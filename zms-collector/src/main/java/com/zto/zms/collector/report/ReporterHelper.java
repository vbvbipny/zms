...
public class ReporterHelper {
	...
	protected void saveStatisticClusterOffset(String clusterName, long maxClusterOffset) {
		...
		dataCarrier.produce(ZmsConst.Measurement.STATISTIC_CLUSTER_DAILY_OFFSETS_INFO,metricsList);
	}
	...
	protected void saveStatisticTopicOffset(String clusterName, String topic, long maxTopicOffset) {
		...
		dataCarrier.produce(ZmsConst.Measurement.STATISTIC_TOPIC_DAILY_OFFSETS_INFO,metricsList);
	}
	...
	public void saveRtMetrics(ClusterRtTime clusterRtTime) {
		...
		dataCarrier.produce(ZmsConst.Measurement.RT_TIME, metricsDoList);
		List<MetricsDo> clusterMetrics = metricsTransformService.transformClusterMetrics(clusterRtTime);
		dataCarrier.produce(ZmsConst.Measurement.CLUSTER_NUMBER_INFO, clusterMetrics);
	}
}
