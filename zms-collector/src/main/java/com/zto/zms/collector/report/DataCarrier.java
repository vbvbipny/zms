 ...
 */
@Component
public class DataCarrier implements DisposableBean {
    private Logger logger = LoggerFactory.getLogger(DataCarrier.class);
    @Autowired
    ...
    private ExecutorService executor = Executors.newFixedThreadPool(20, r -> new Thread(r, "DataCarrier-Consumer-Thread"));

    public boolean produce(final String topic, List<MetricsDo> data) {
