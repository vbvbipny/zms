...
package com.zto.zms.alert.selector;
 ...
 **/
@Component
public class AlertZookeeperSelector implements ZookeeperSelector, DisposableBean {

	private static Logger logger = LoggerFactory.getLogger(AlertZookeeperSelector.class);
