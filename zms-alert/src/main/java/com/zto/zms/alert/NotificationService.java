...
import com.zto.zms.alert.dto.AlertRuleConfig;
...
public class NotificationService {
    ...
    Executor influxAlertService = Executors.newSingleThreadExecutor(new ThreadFactory() {
        @Override
        public Thread newThread(Runnable r) {
            return new Thread(r, "influx-write-alert-thread");
        }
    });
    ...
    public void sendDingdingGroup(AlertRuleConfig rule) {
        ...
        String textMsg = "{ \"msgtype\": \"text\", \"text\": {\"content\": \"%s\"}}";
        String errorMsg = String.format(textMsg, rule.getDescription());
